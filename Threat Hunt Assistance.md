...
- [🕵️ Flag 1 - Initial Execution Detection](#flag-1---initial-execution-detection)
- [🏰 Flag 2 - Defense Disabling](#flag-2---defense-disabling)
- [🔍 Flag 3 - Quick Data Probe](#flag-3---quick-data-probe)
- [👁️ Flag 4 - Host Context Recon](#flag-4---host-context-recon)
- [🗺️ Flag 5 - Storage Surface Mapping](#flag-5---storage-surface-mapping)
